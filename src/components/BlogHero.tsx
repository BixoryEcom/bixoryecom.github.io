      ...
      <div className="relative z-30 container mx-auto px-4 h-[calc(500px-4rem)] flex items-center justify-center">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 text-white animate-fade-in">
            Insights &I'll update the BlogHero component to match the style of the Home page's HeroSection, using similar background image opacity and overlay gradients to ensure better text visibility.

<lov-code>
Let's update the BlogHero component to match the HeroSection styling:

<lov-write file_path="src/components/BlogHero.tsx">
const BlogHero = () => {
  return (
    <div className="relative overflow-hidden min-h-[500px] pt-16">
      {/* Background Image */}
