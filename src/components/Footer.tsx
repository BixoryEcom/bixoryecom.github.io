      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 text-center md:text-center">
            <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity justify-center">
              <img 
            ...
            <p className="text-sm font-['Playfair_Display'] text-[#FFD700] italic text-center">Build Next-gen eCommerce with AI</p>
